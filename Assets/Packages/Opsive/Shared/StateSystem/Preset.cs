...
namespace Opsive.Shared.StateSystem
{
    ...
    public class Preset : ScriptableObject
    {
        ...
        private Dictionary<Type, Type> m_DelegatePool = new Dictionary<Type, Type>();
        ...
        public virtual void Initialize(object obj, MemberVisibility visibility)
        {
            ...
            for (int i = 0; i < properties.Length; ++i) {
                ...
                if (!m_DelegatePool.TryGetValue(propertyInfo.PropertyType, out genericDelegateType)) {
                    genericDelegateType = typeof(GenericDelegate<>).MakeGenericType(propertyInfo.PropertyType);
                    m_DelegatePool.Add(propertyInfo.PropertyType, genericDelegateType);
                }
        ...
        public abstract class BaseDelegate
        {
            ...
            /// <param name="visibility">Specifies the visibility of the field/properties that should be retrieved.</param>
            public abstract void Initialize(object obj, PropertyInfo property, Dictionary<long, int> valuePositionMap, Serialization data, MemberVisibility visibility);
        ...
        public class GenericDelegate<T> : BaseDelegate
        {
            ...
            /// <param name="data">The serialization data which contains the values for the property (as well as all other properties).</param>
            /// <param name="visibility">Specifies the visibility of the field/properties that should be retrieved.</param>
            public override void Initialize(object obj, PropertyInfo property, Dictionary<long, int> valuePositionMap, Serialization data, MemberVisibility visibility)
            {
                ...
                if (m_SetMethod != null) {
                    ...
                    var value = Serializer.BytesToValue(typeof(T), property.Name, valuePositionMap, 0, data.Values, data.ValuePositions, data.UnityObjects, false, visibility, Serialization.GetHashType(data.Version));
